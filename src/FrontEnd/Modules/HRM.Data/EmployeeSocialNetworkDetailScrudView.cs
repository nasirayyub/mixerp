...
namespace MixERP.Net.Core.Modules.HRM.Data
{
    ...
    public class EmployeeSocialNetworkDetailScrudView : DbAccess
    {
        ...
        /// <summary>
        /// Executes a select query on the view "hrm.employee_social_network_detail_scrud_view" to return a all instances of the "EmployeeSocialNetworkDetailScrudView" class. 
        /// </summary>
