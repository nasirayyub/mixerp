...
namespace MixERP.Net.Api.HRM
{
    ...
    {
        /// <summary>
        ///     The ContractVerificationScrudView data context.
        /// </summary>
        private readonly MixERP.Net.Core.Modules.HRM.Data.ContractVerificationScrudView ContractVerificationScrudViewContext;
        ...
        public ContractVerificationScrudViewController()
        {
            ...
            this.ContractVerificationScrudViewContext = new MixERP.Net.Core.Modules.HRM.Data.ContractVerificationScrudView
            {
        ...
        public long Count()
        {
            try
            {
                return this.ContractVerificationScrudViewContext.Count();
            }
        ...
        public IEnumerable<MixERP.Net.Entities.HRM.ContractVerificationScrudView> Get()
        {
            try
            {
                return this.ContractVerificationScrudViewContext.Get();
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        public IEnumerable<MixERP.Net.Entities.HRM.ContractVerificationScrudView> GetPaginatedResult()
        {
            try
            {
                return this.ContractVerificationScrudViewContext.GetPaginatedResult();
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        public IEnumerable<MixERP.Net.Entities.HRM.ContractVerificationScrudView> GetPaginatedResult(long pageNumber)
        {
            try
            {
                return this.ContractVerificationScrudViewContext.GetPaginatedResult(pageNumber);
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        public IEnumerable<DisplayField> GetDisplayFields()
        {
            try
            {
                return this.ContractVerificationScrudViewContext.GetDisplayFields();
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        public long CountWhere([FromBody]JArray filters)
        {
            try
            {
                ...
                return this.ContractVerificationScrudViewContext.CountWhere(f);
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        public IEnumerable<MixERP.Net.Entities.HRM.ContractVerificationScrudView> GetWhere(long pageNumber, [FromBody]JArray filters)
        {
            ...
            {
                List<EntityParser.Filter> f = filters.ToObject<List<EntityParser.Filter>>(JsonHelper.GetJsonSerializer());
                return this.ContractVerificationScrudViewContext.GetWhere(pageNumber, f);
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        public long CountFiltered(string filterName)
        {
            try
            {
                return this.ContractVerificationScrudViewContext.CountFiltered(filterName);
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        public IEnumerable<MixERP.Net.Entities.HRM.ContractVerificationScrudView> GetFiltered(long pageNumber, string filterName)
        {
            try
            {
                return this.ContractVerificationScrudViewContext.GetFiltered(pageNumber, filterName);
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
