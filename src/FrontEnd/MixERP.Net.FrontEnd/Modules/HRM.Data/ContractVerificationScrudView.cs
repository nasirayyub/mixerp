...
namespace MixERP.Net.Core.Modules.HRM.Data
{
    ...
    /// </summary>
    public class ContractVerificationScrudView : DbAccess
    {
        /// <summary>
        ...
        /// <summary>
        /// Performs a select statement on the view "hrm.contract_verification_scrud_view" producing a paged result of 10.
        /// </summary>
        /// <returns>Returns the first page of collection of "ContractVerificationScrudView" class.</returns>
        /// <exception cref="UnauthorizedException">Thown when the application user does not have sufficient privilege to perform this action.</exception>
        public IEnumerable<MixERP.Net.Entities.HRM.ContractVerificationScrudView> GetPagedResult()
        {
            if (string.IsNullOrWhiteSpace(this._Catalog))
            {
                return null;
        ...
        /// <exception cref="UnauthorizedException">Thown when the application user does not have sufficient privilege to perform this action.</exception>
        public IEnumerable<MixERP.Net.Entities.HRM.ContractVerificationScrudView> GetPagedResult(long pageNumber)
        {
            if (string.IsNullOrWhiteSpace(this._Catalog))
            {
                return null;
        ...
        /// <summary>
        /// Performs a filtered select statement on view "hrm.contract_verification_scrud_view" producing a paged result of 10.
        /// </summary>
        /// <param name="pageNumber">Enter the page number to produce the paged result.</param>
        /// <param name="filters">The list of filter conditions.</param>
        /// <returns>Returns collection of "ContractVerificationScrudView" class.</returns>
