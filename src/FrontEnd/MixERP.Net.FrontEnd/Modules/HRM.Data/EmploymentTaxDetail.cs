...
namespace MixERP.Net.Core.Modules.HRM.Data
{
    ...
    public class EmploymentTaxDetail : DbAccess
    {
        ...
        /// <summary>
        /// Performs a select statement on table "hrm.employment_tax_details" producing a paged result of 10.
        /// </summary>
        ...
        /// <summary>
        /// Performs a filtered select statement on table "hrm.employment_tax_details" producing a paged result of 10.
        /// </summary>
        /// <param name="pageNumber">Enter the page number to produce the paged result.</param>
        /// <param name="filters">The list of filter conditions.</param>
        /// <returns>Returns collection of "EmploymentTaxDetail" class.</returns>
