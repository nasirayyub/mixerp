...
namespace MixERP.Net.Core.Modules.HRM.Data
{
    ...
    public class WagesSetup : DbAccess
    {
        ...
        /// <summary>
        /// Performs a select statement on table "hrm.wages_setup" producing a paginated result of 10.
        /// </summary>
        /// <returns>Returns the first page of collection of "WagesSetup" class.</returns>
        /// <exception cref="UnauthorizedException">Thown when the application user does not have sufficient privilege to perform this action.</exception>
        public IEnumerable<MixERP.Net.Entities.HRM.WagesSetup> GetPaginatedResult()
        {
            if (string.IsNullOrWhiteSpace(this._Catalog))
            {
                return null;
        ...
        /// <exception cref="UnauthorizedException">Thown when the application user does not have sufficient privilege to perform this action.</exception>
        public IEnumerable<MixERP.Net.Entities.HRM.WagesSetup> GetPaginatedResult(long pageNumber)
        {
            if (string.IsNullOrWhiteSpace(this._Catalog))
            {
                return null;
        ...
        /// <summary>
        /// Performs a filtered select statement on table "hrm.wages_setup" producing a paginated result of 10.
        /// </summary>
