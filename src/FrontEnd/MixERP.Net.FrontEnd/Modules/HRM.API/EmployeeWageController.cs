...
namespace MixERP.Net.Api.HRM
{
    ...
    public class EmployeeWageController : ApiController
    {
                ...
                Columns = new List<EntityColumn>()
                                {
                                        ...
                                        new EntityColumn { ColumnName = "wage_setup_id",  PropertyName = "WageSetupId",  DataType = "int",  DbDataType = "int4",  IsNullable = false,  IsPrimaryKey = false,  IsSerial = false,  Value = "",  MaxLength = 0 },
                                        ...
                                        new EntityColumn { ColumnName = "posting_account_id",  PropertyName = "PostingAccountId",  DataType = "long",  DbDataType = "int8",  IsNullable = false,  IsPrimaryKey = false,  IsSerial = false,  Value = "",  MaxLength = 0 },
        ...
        [Route("~/api/hrm/employee-wage/all")]
        ...
        public IEnumerable<MixERP.Net.Entities.HRM.EmployeeWage> GetPaginatedResult()
        {
            try
            {
                return this.EmployeeWageContext.GetPaginatedResult();
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        public IEnumerable<MixERP.Net.Entities.HRM.EmployeeWage> GetPaginatedResult(long pageNumber)
        {
            try
            {
                return this.EmployeeWageContext.GetPaginatedResult(pageNumber);
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
