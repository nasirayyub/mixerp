...
namespace MixERP.Net.Api.HRM
{
    ...
    public class SalaryController : ApiController
    {
                ...
                Columns = new List<EntityColumn>()
                                {
                                        ...
                                        new EntityColumn { ColumnName = "provident_fund_id",  PropertyName = "ProvidentFundId",  DataType = "int",  DbDataType = "int4",  IsNullable = true,  IsPrimaryKey = false,  IsSerial = false,  Value = "",  MaxLength = 0 },
                                        new EntityColumn { ColumnName = "employment_tax_id",  PropertyName = "EmploymentTaxId",  DataType = "int",  DbDataType = "int4",  IsNullable = true,  IsPrimaryKey = false,  IsSerial = false,  Value = "",  MaxLength = 0 },
                                        new EntityColumn { ColumnName = "salary_tax_id",  PropertyName = "SalaryTaxId",  DataType = "int",  DbDataType = "int4",  IsNullable = true,  IsPrimaryKey = false,  IsSerial = false,  Value = "",  MaxLength = 0 },
        ...
        public IEnumerable<MixERP.Net.Entities.HRM.Salary> GetPaginatedResult()
        {
            try
            {
                return this.SalaryContext.GetPaginatedResult();
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        public IEnumerable<MixERP.Net.Entities.HRM.Salary> GetPaginatedResult(long pageNumber)
        {
            try
            {
                return this.SalaryContext.GetPaginatedResult(pageNumber);
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
