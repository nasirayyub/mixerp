...
namespace MixERP.Net.Entities.HRM
{
    ...
    [TableName("hrm.provident_fund_holding_account_selector_view")]
    [ExplicitColumns]
    public sealed class ProvidentFundHoldingAccountSelectorView : PetaPocoDB.Record<ProvidentFundHoldingAccountSelectorView>, IPoco
    {
        [Column("account_id")]
