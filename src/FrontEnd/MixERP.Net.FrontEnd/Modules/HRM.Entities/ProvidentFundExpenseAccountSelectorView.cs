...
namespace MixERP.Net.Entities.HRM
{
    ...
    [TableName("hrm.provident_fund_expense_account_selector_view")]
    [ExplicitColumns]
    public sealed class ProvidentFundExpenseAccountSelectorView : PetaPocoDB.Record<ProvidentFundExpenseAccountSelectorView>, IPoco
    {
        [Column("account_id")]
