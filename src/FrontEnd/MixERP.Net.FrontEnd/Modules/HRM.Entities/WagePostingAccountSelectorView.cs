...
namespace MixERP.Net.Entities.HRM
{
    ...
    [TableName("hrm.wage_posting_account_selector_view")]
    [ExplicitColumns]
    public sealed class WagePostingAccountSelectorView : PetaPocoDB.Record<WagePostingAccountSelectorView>, IPoco
    {
        [Column("account_id")]
