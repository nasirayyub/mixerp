...
{
    public class ItemVariantDetailTests
    {
        public static ItemVariantDetailController Fixture()
        {
            ItemVariantDetailController controller = new ItemVariantDetailController(new ItemVariantDetailRepository(), "", new LoginView());
            return controller;
        }
        ...
        public void Get()
        {
            MixERP.Net.Entities.Core.ItemVariantDetail itemVariantDetail = Fixture().Get(0);
            Assert.NotNull(itemVariantDetail);
        }
        ...
        {
            IEnumerable<MixERP.Net.Entities.Core.ItemVariantDetail> itemVariantDetails = Fixture().Get(new int[] { });
            Assert.NotNull(itemVariantDetails);
        }
