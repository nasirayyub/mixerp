...
{
    public class ItemVariantDetailScrudViewTests
    {
        public static ItemVariantDetailScrudViewController Fixture()
        {
            ItemVariantDetailScrudViewController controller = new ItemVariantDetailScrudViewController(new ItemVariantDetailScrudViewRepository(), "", new LoginView());
            return controller;
        }
