...
namespace MixERP.Net.Schemas.Core.Data
{
    ...
    public class ZipCodeType : DbAccess
    {
        ...
        /// <summary>
        /// Executes a select query on the table "core.zip_code_types" to return a all instances of the "ZipCodeType" class. 
        /// </summary>
        ...
        public object AddOrEdit(dynamic zipCodeType, List<EntityParser.CustomField> customFields)
        {
            ...
            if (Cast.To<int>(zipCodeType.zip_code_type_id) > 0)
            {
