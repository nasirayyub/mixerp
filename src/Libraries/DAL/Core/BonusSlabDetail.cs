...
namespace MixERP.Net.Schemas.Core.Data
{
    ...
    public class BonusSlabDetail : DbAccess
    {
        ...
        /// <summary>
        /// Executes a select query on the table "core.bonus_slab_details" to return a all instances of the "BonusSlabDetail" class. 
        /// </summary>
        ...
        public object AddOrEdit(dynamic bonusSlabDetail, List<EntityParser.CustomField> customFields)
        {
            ...
            if (Cast.To<int>(bonusSlabDetail.bonus_slab_detail_id) > 0)
            {
