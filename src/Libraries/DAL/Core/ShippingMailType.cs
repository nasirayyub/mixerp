...
namespace MixERP.Net.Schemas.Core.Data
{
    ...
    public class ShippingMailType : DbAccess
    {
        ...
        /// <summary>
        /// Executes a select query on the table "core.shipping_mail_types" to return a all instances of the "ShippingMailType" class. 
        /// </summary>
        ...
        public object AddOrEdit(dynamic shippingMailType, List<EntityParser.CustomField> customFields)
        {
            ...
            if (Cast.To<int>(shippingMailType.shipping_mail_type_id) > 0)
            {
