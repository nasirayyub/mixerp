...
namespace MixERP.Net.Schemas.Policy.Data
{
    ...
    public class StorePolicy : DbAccess
    {
        ...
        /// <summary>
        /// Executes a select query on the table "policy.store_policies" to return a all instances of the "StorePolicy" class. 
        /// </summary>
        ...
        public object AddOrEdit(dynamic storePolicy, List<EntityParser.CustomField> customFields)
        {
            ...
            if (Cast.To<long>(storePolicy.store_policy_id) > 0)
            {
