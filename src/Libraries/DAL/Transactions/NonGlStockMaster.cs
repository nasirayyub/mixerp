...
namespace MixERP.Net.Schemas.Transactions.Data
{
    ...
    public class NonGlStockMaster : DbAccess
    {
        ...
        /// <summary>
        /// Executes a select query on the table "transactions.non_gl_stock_master" to return a all instances of the "NonGlStockMaster" class. 
        /// </summary>
        ...
        public object AddOrEdit(dynamic nonGlStockMaster, List<EntityParser.CustomField> customFields)
        {
            ...
            if (Cast.To<long>(nonGlStockMaster.non_gl_stock_master_id) > 0)
            {
